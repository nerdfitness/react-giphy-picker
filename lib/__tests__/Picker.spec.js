...
test('Picker renders correctly and matches snapshot', function () {
  ...
  var component = _reactTestRenderer.default.create( /*#__PURE__*/_react.default.createElement(_Picker.default, {
...
test('Picker renders the correct elements and props', function () {
  var handleSelected = jest.fn();
  var wrapper = (0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(_Picker.default, {
    onSelected: handleSelected
  }));
